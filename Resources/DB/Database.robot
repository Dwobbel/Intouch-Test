...
Save Current Row Count
    ${current_row_count} =  Row Count  SELECT * FROM tradelec_statements.observation_statement;
...
Log All Rows
    ${queryResults} =  Query  SELECT * FROM tradelec_statements.objection ORDER BY ID
